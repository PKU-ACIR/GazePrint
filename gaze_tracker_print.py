...
class GAZE_TRACKER():
    def __init__(self,depth_scale):
        ...
        self.writer = cv2.VideoWriter("videolast.avi",fourcc,30,(3840,2160))
    ...
    def run(self, color_image, depth_image, depth_intrin,has_depth=False):
        ...
        if faces:
           ...
           # print(mydis)
            ...
            self.gaze_estimator.estimate_gaze(color_image, target_face)
            ...
            return True,flag,self.focusing,attention_vec,face_center
        
        return False,True,self.focusing,[0,0,0],[0,0,0]
